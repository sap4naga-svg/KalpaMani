...
| **no skip link reached a table** | section 10 asks for skip links to "the main content **and** the primary table"; only the first existed, so reaching a ledger by keyboard meant tabbing past the header and thirty-one sidebar links. The second link appears only once a table exists to point at |
