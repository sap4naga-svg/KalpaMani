"""ADR-0038 governance: a proposed, narrow amendment adding the production run reservation.

These checks hold the document to its own claims -- proposed and not in force, one object
class under the accepted claim namespace, the effectiveness and execution gates stated --
and hold the offline implementation to the shape the document describes.
"""
