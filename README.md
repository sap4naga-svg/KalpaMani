...
ADR-0044 delivery contracts + packaging (code):   OFFLINE / SYNTHETIC-ONLY / NO IMAGE / NEVER RUN — proposed, open PR; CompiledTask v2, release v2, acquisition input v2, compiled-configuration file, receipt line and validator, Dockerfile and generator; compiled configuration file absent by design
...
delivery contracts + packaging (code):             OFFLINE / SYNTHETIC-ONLY — proposed in an open PR (ADR-0044); release v2 attests image and configuration digests, acquisition input v2 carries spent identities, receipt line bound by digest, Dockerfile/generator prepared; no image built
ADR-0038 (production run reservation):             ACCEPTED / IN FORCE — PR #96 merged 2026-09-12T15:10:12Z
