...
`main`** (PR #96), the **research-build processing path is proposed in an open pull request**, and **no
production image and no entry point exists**.
...
ADR-0036 acquisition processing (code):           OFFLINE / SYNTHETIC-ONLY / NO PROVIDER ADAPTER / NO IMAGE — on main, PR #96 merged 2026-09-12T15:10:12Z
ADR-0038 (production run reservation):            ACCEPTED / IN FORCE — PR #96 merged 2026-09-12T15:10:12Z
ADR-0036 build processing (code):                 OFFLINE / SYNTHETIC-ONLY / NO IMAGE — proposed, open PR; run_build_task still halts, run_production_build is the processing path
ADR-0039 (two universe exclusion reasons):        PROPOSED — NOT IN FORCE
ADR-0040 (build output objects and manifest):     PROPOSED — NOT IN FORCE
production ingestion/backfill/update:             NOT AUTHORIZED / NOT RUN
...
**The offline research-build processing path (proposed in a later, open pull request; not on `main`).** Under a
...
acquisition processing (code):                     OFFLINE / SYNTHETIC-ONLY — on main, PR #96 merged 2026-09-12T15:10:12Z; no provider adapter can reach the wire
ADR-0038 (production run reservation):             ACCEPTED / IN FORCE — PR #96 merged 2026-09-12T15:10:12Z
build processing (code):                           OFFLINE / SYNTHETIC-ONLY — proposed in an open PR; synthetic calendar; ADR-0039 and ADR-0040 proposed
production image / entry point:                    NONE
