...
**This section governs the applied state.** Every per-merge section below records what was true on
its own merge date and now carries a historical banner: its existence, occurrence and deployment
lines describe that day and no longer govern, while its forward authorization boundaries are
unchanged. **No ADR document and no historical review report is rewritten by this
synchronization.**
