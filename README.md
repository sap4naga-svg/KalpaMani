...
— **PROPOSED, and carrying no authority while its pull request is open** — which declares no Terraform,
applies nothing, materializes nothing and authorizes no ingestion.
...
ADR-0036 (production principals):                 PROPOSED — NOT IN FORCE
production ingestion/backfill/update:             NOT AUTHORIZED / NOT RUN
...
both, itself behind the principals ADR-0036 designs. **Acceptance,
