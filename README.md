...
authorizes nothing**. **Both ADRs are proposed on one pull request and become effective together on its
single independently reviewed merge; ADR-0035 depends on ADR-0034 and cannot be in force without it.**
...
ADR-0034 / ADR-0035:                              PROPOSED — NOT IN FORCE; effective together on one merge, ADR-0035 dependent on ADR-0034
production ingestion/backfill/update:             NOT AUTHORIZED / NOT RUN
