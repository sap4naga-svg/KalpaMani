...
qualification resources are unchanged.
...
ADR-0037 (disjoint production namespaces):        PROPOSED — NOT IN FORCE
production ingestion/backfill/update:             NOT AUTHORIZED / NOT RUN
