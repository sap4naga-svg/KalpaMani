...
IN FORCE       ADR-0009 provider-specific code (PR #13 merged)
               ...
               ADR-0015 dormant private-binding preflight -- ACCEPTED / IN FORCE --
                        ...
                        SHARADAR REQUEST OR QUALIFICATION RUN; A FIFTH ATTEMPT
                        AND AWS AUTHENTICATION DIAGNOSIS NOT AUTHORIZED
...
NOT AUTHORIZED application credential retrieval
               ...
               AWS authentication diagnosis or an SSO refresh -- separately gated;
                        a refusal at the identity gate is a completed diagnostic
                        result, not permission to repair and try again
