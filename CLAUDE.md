...
NOT AUTHORIZED · further AWS authentication diagnosis NOT AUTHORIZED · a fifth binding-preflight
...
IN FORCE       ADR-0009 provider-specific code (PR #13 merged)
               ...
               ADR-0015 dormant private-binding preflight -- ACCEPTED / IN FORCE --
                        ...
                        PREFLIGHT ONLY; FOUR SEPARATELY AUTHORIZED ATTEMPTS, ALL
                        REFUSED, THE THIRD WITH REFUSED_SECRET_IDENTIFIER AT THE
                        SECRET-IDENTIFIER SOURCE AND THE FOURTH WITH
                        REFUSED_IDENTITY AT THE AWS IDENTITY GATE; SECRET
                        IDENTIFIER OWNER-CONFIGURED / NOT YET VERIFIED BY THE
                        ENTRY POINT, SET UP AFTER THE THIRD ATTEMPT AND NOT READ
                        BY THE FOURTH, WHICH REACHED NEITHER BUCKET NOR
                        IDENTIFIER RESOLUTION; AWS IDENTITY-GATE ACTIVITY
                        OCCURRED, FOURTH-ATTEMPT AWS NETWORK REQUESTS UNKNOWN; NO
                        SECRETS MANAGER CLIENT, CREDENTIAL, S3 OBJECT OPERATION,
                        SHARADAR REQUEST OR QUALIFICATION RUN; POST-FOURTH AWS
                        ...
                        UNREFRESHED, EARLIER DIAGNOSIS UNREVISED, LIKELY CAUSE
                        INTERACTIVE-SURFACE SUPPRESSION -- LIKELY, NOT PROVEN;
                        A FIFTH ATTEMPT, FURTHER AWS AUTHENTICATION DIAGNOSIS
                        AND ANOTHER SSO-LOGIN/REFRESH ATTEMPT NOT AUTHORIZED
               ADR-0016 corrected private-binding failure boundaries -- ACCEPTED /
                        ...
                        RESYNCHRONIZATION SEPARATELY GATED, A FIFTH BINDING-PREFLIGHT
...
NOT AUTHORIZED application credential retrieval
               ...
               a fifth binding-preflight attempt -- four have occurred and all refused;
               ...
               another AWS SSO refresh or login -- separately gated; one authorized
                        attempt occurred and timed out, and a failed login is not
                        permission to retry, any more than classifying a session as
                        missing or expired was permission to replace it
...
ENVIRONMENT    operational .venv and AWS SDK PRESENT / VERIFIED -- Python 3.11.9,
               ...
               UNREFRESHED, EARLIER DIAGNOSIS UNREVISED, LIKELY CAUSE
               INTERACTIVE-SURFACE SUPPRESSION -- LIKELY, NOT PROVEN
               SECRET IDENTIFIER OWNER-CONFIGURED / NOT YET VERIFIED BY THE ENTRY
               POINT, AND NOT READ BY THE FOURTH ATTEMPT
