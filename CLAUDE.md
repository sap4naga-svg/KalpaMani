...
IN FORCE       ADR-0009 provider-specific code (PR #13 merged)
               ...
               ADR-0015 dormant private-binding preflight -- ACCEPTED / IN FORCE --
                        ...
                        NETWORK COUNT UNKNOWN, ZERO SSO LOGINS, ZERO REPAIR
                        ACTIONS; A FIFTH ATTEMPT AND FURTHER AWS AUTHENTICATION
...
NOT AUTHORIZED application credential retrieval
               ...
               an AWS SSO refresh or login -- separately gated; classifying a session
                        as missing or expired is not permission to replace it
