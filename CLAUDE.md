...
IN FORCE       ADR-0009 provider-specific code (PR #13 merged)
               ...
               ADR-0018 bounded private empirical Sharadar qualification --
                        ...
                        CANDIDATE IS UNMERGED, NOT ACCEPTED AND BLOCKED, AND
                        THE OFFLINE IMPLEMENTATION CANDIDATE MUST BE CORRECTED
                        AGAINST THE NOW-AUTHORITATIVE CLARIFICATION UNDER A
                        SEPARATELY AUTHORIZED IMPLEMENTATION CORRECTION AND AN
                        INDEPENDENT RE-REVIEW. A SANITIZED RUNTIME-AREA LISTING INCIDENT IS
...
offline implementation candidate:         UNMERGED AND BLOCKED -- pending a separately
                                          authorized implementation correction against
                                          the now-authoritative clarification, and an
